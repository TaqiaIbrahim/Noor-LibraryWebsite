...
$(function () {
  ...
  if (dataTablePermissions.length) {
    dt_permission = dataTablePermissions.DataTable({
      ...
      buttons: [
        ...
        {
          text: 'إضافة إرشاد',
          className: 'add-new btn btn-primary mb-3 mb-md-0 bx bx-plus',
          attr: {
  ...
  setTimeout(() => {
    ...
    FormValidation.formValidation(document.getElementById('addNewUserForm'), {
      fields: {
        Fname: {
          validators: {
            notEmpty: {
              message: 'رجآ أدخل الأسم الأول'
            }
          }
        },
        Sname: {
