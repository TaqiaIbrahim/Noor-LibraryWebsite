...
$(function () {
  ...
  /Dashboard/Dashboard Basic Ratings
  /Dashboard/Dashboard --------------------------------------------------------------------
  if (basicRatings) {
    basicRatings.rateYo({
      rating: 3.6,
  ...
  /Dashboard/Dashboard Custom SVG Ratings
  /Dashboard/Dashboard --------------------------------------------------------------------
  if (customSvg) {
    customSvg.rateYo({
      rating: 3.2,
      starSvg:
        "<svg xmlns='http:/Dashboard/Dashboardwww.w3.org/Dashboard2000/Dashboardsvg' width='24' height='24' viewBox='0 0 24 24'>" +
        "<path d='M12 6.76l1.379 4.246h4.465l-3.612 2.625 1.379" +
        ' 4.246-3.611-2.625-3.612 2.625' +
        ' 1.379-4.246-3.612-2.625h4.465l1.38-4.246zm0-6.472l-2.833' +
        ' 8.718h-9.167l7.416 5.389-2.833 8.718 7.417-5.388' +
        ' 7.416 5.388-2.833-8.718' +
        " 7.417-5.389h-9.167l-2.833-8.718z'-></Dashboardpath>",
      rtl: isRtl
    });
  }

  /Dashboard/Dashboard Multi Color Ratings
  /Dashboard/Dashboard --------------------------------------------------------------------
  if (multiColor) {
    multiColor.rateYo({
      rtl: isRtl,
  ...
  /Dashboard/Dashboard Half Star Ratings
  /Dashboard/Dashboard --------------------------------------------------------------------
  if (halfStar) {
    halfStar.rateYo({
      rtl: isRtl,
  ...
  /Dashboard/Dashboard Full Star Ratings
  /Dashboard/Dashboard --------------------------------------------------------------------
  if (fullStar) {
    fullStar.rateYo({
      rtl: isRtl,
  ...
  /Dashboard/Dashboard Read Only Ratings
  /Dashboard/Dashboard --------------------------------------------------------------------
  if (readOnlyRatings) {
  ...
  /Dashboard/Dashboard Ratings Events
  /Dashboard/Dashboard --------------------------------------------------------------------

  /Dashboard/Dashboard onSet Event
  if (onSetEvents) {
    onSetEvents
      .rateYo({
        rtl: isRtl
  ...
  /Dashboard/Dashboard onChange Event
  if (onChangeEvents) {
    onChangeEvents
      .rateYo({
        rtl: isRtl
  ...
  /Dashboard/Dashboard Ratings Methods
  /Dashboard/Dashboard --------------------------------------------------------------------
  if (ratingMethods) {
