  ...
  (function () {
    ...
    for (let pin of maskWrapper.children) {
      pin.onkeyup = function (e) {
        /Dashboard/Dashboard While entering value, go to next
        ...
        /Dashboard/Dashboard While deleting entered value, go to previous
        /Dashboard/Dashboard Delete using backspace and delete
