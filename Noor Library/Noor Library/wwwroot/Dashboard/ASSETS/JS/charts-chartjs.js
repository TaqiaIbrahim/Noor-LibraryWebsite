...
(function () {
  /Dashboard/Dashboard Color Variables
  ...
  if (isDarkStyle) {
    ...
    axisColor = config.colors_dark.axisColor; /Dashboard/Dashboard x & y axis tick color
  } else {
    borderColor = config.colors.borderColor; /Dashboard/Dashboard same as template border color
    axisColor = config.colors.axisColor; /Dashboard/Dashboard x & y axis tick color\
  }

  /Dashboard/Dashboard Set height according to their data-height
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  /Dashboard/Dashboard Horizontal Bar Chart
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  if (lineChart) {
    const lineChartVar = new Chart(lineChart, {
      ...
      options: {
        ...
        plugins: {
          tooltip: {
            /Dashboard/Dashboard Updated default tooltip UI
            rtl: isRtl,
            backgroundColor: config.colors.white,
            titleColor: config.colors.black,
            bodyColor: config.colors.black,
  ...
  /Dashboard/Dashboard Radar Chart
  /Dashboard/Dashboard --------------------------------------------------------------------

  const radarChart = document.getElementById('radarChart');
  if (radarChart) {
    /Dashboard/Dashboard For radar gradient color
  ...
  /Dashboard/Dashboard Polar Chart
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  /Dashboard/Dashboard Bubble Chart
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  /Dashboard/Dashboard Doughnut Chart
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  /Dashboard/Dashboard Scatter Chart
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  /Dashboard/Dashboard LineArea Chart
  /Dashboard/Dashboard --------------------------------------------------------------------
