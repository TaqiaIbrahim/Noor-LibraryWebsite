...
(function () {
  /Dashboard/Dashboard Data Variable
  const statesData = {
  ...
  if (basicMapVar) {
    ...
    L.tileLayer('https:/Dashboard/Dashboard{s}.tile.osm.org/Dashboard{z}/Dashboard{x}/Dashboard{y}.png', {
      attribution: 'Map data &copy; <a href="https:/Dashboard/Dashboardwww.openstreetmap.org/Dashboard">OpenStreetMap</Dashboarda>',
      maxZoom: 18
    }).addTo(basicMap);
  }

  /Dashboard/Dashboard Markers
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  /Dashboard/Dashboard Drag and popup
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  if (dragMapVar) {
    ...
    markerLocation.bindPopup("<b>You're here!</Dashboardb>").openPopup();
    L.tileLayer('https:/Dashboard/Dashboard{s}.tile.osm.org/Dashboard{z}/Dashboard{x}/Dashboard{y}.png', {
      attribution: 'Map data &copy; <a href="https:/Dashboard/Dashboardwww.openstreetmap.org/Dashboard">OpenStreetMap</Dashboarda>',
      maxZoom: 18
    }).addTo(draggableMap);
  ...
  /Dashboard/Dashboard User location
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  if (customIconsVar) {
    ...
    const greenLeaf = L.icon({
      iconUrl: assetsPath + 'img/Dashboardicons/Dashboardmisc/Dashboardleaf-green.png',
      shadowUrl: assetsPath + 'img/Dashboardicons/Dashboardmisc/Dashboardleaf-shadow.png',
      iconSize: [38, 95],
      shadowSize: [50, 64],
      iconAnchor: [22, 94],
      shadowAnchor: [4, 62],
    ...
    const redLeaf = L.icon({
      iconUrl: assetsPath + 'img/Dashboardicons/Dashboardmisc/Dashboardleaf-red.png',
      shadowUrl: assetsPath + 'img/Dashboardicons/Dashboardmisc/Dashboardleaf-shadow.png',
      iconSize: [38, 95],
      shadowSize: [50, 64],
      iconAnchor: [22, 94],
    ...
    const orangeLeaf = L.icon({
      iconUrl: assetsPath + 'img/Dashboardicons/Dashboardmisc/Dashboardleaf-orange.png',
      shadowUrl: assetsPath + 'img/Dashboardicons/Dashboardmisc/Dashboardleaf-shadow.png',
      iconSize: [38, 95],
      shadowSize: [50, 64],
      iconAnchor: [22, 94],
  ...
  /Dashboard/Dashboard Layer Control
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  if (layerControlVar) {
    ...
    const street = L.tileLayer('https:/Dashboard/Dashboard{s}.tile.osm.org/Dashboard{z}/Dashboard{x}/Dashboard{y}.png', {
        attribution: 'Map data &copy; <a href="https:/Dashboard/Dashboardwww.openstreetmap.org/Dashboard">OpenStreetMap</Dashboarda>',
        maxZoom: 18
      }),
      watercolor = L.tileLayer('http:/Dashboard/Dashboardtile.stamen.com/Dashboardwatercolor/Dashboard{z}/Dashboard{x}/Dashboard{y}.jpg', {
        attribution: 'Map data &copy; <a href="https:/Dashboard/Dashboardwww.openstreetmap.org/Dashboard">OpenStreetMap</Dashboarda>',
        maxZoom: 18
      });
    ...
    L.tileLayer('https:/Dashboard/Dashboardc.tile.osm.org/Dashboard{z}/Dashboard{x}/Dashboard{y}.png', {
      attribution: 'Map data &copy; <a href="https:/Dashboard/Dashboardwww.openstreetmap.org/Dashboard">OpenStreetMap</Dashboarda>',
      maxZoom: 18
    }).addTo(layerControl);
  }
