...
$(function () {
  ...
  /Dashboard/Dashboard Project datatable
  /Dashboard/Dashboard --------------------------------------------------------------------
  if (dt_project_table.length) {
    var dt_project = dt_project_table.DataTable({
      ajax: assetsPath + 'json/Dashboardprojects-list.json', /Dashboard/Dashboard JSON file to add data
      columns: [
          ...
          render: function (data, type, full, meta) {
            ...
            if ($image) {
              ...
              var $output =
                '<img src="' +
                assetsPath +
                'img/Dashboardicons/Dashboardbrands/Dashboard' +
                $image +
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var roleBadgeObj = {
              Sent: '<span class="badge badge-center rounded-pill bg-label-secondary w-px-30 h-px-30 "><i class="bx bx-mail-send bx-xs"></Dashboardi></Dashboardspan>',
              Draft:
            ...
            return (
              ...
              $invoice_status +
              '<br> <strong>Balance:</Dashboardstrong> ' +
              $balance +
              '<br> <strong>Due Date:</Dashboardstrong> ' +
              $due_date +
              "</Dashboardspan>'>" +
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="javascript:;" class="text-body" data-bs-toggle="tooltip" title="Send Mail"><i class="bx bx-paper-plane mx-1"></Dashboardi></Dashboarda>' +
              '<a href="app-invoice-preview.html" class="text-body" data-bs-toggle="tooltip" title="Preview"><i class="bx bx-show-alt mx-1"></Dashboardi></Dashboarda>' +
              '<a href="javascript:;" class="text-body" data-bs-toggle="tooltip" title="Download"><i class="bx bx-download mx-1"></Dashboardi></Dashboarda>' +
              '</Dashboarddiv>'
            );
          }
        }
