...
$(function () {
  ...
  if (dtUserTable.length) {
    dtUserTable.DataTable({
      ajax: assetsPath + '/Dashboardjson/Dashboarduser-list.json', /Dashboard/Dashboard JSON file to add data
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            if ($image) {
              ...
              var $output =
                '<img src="' + assetsPath + 'img/Dashboardavatars/Dashboard' + $image + '" alt="Avatar" class="rounded-circle">';
            } else {
        ...
        },
        {
          ...
          orderable: false,
          render: function (data, type, full, meta) {
            return '<a href="' + userView + '" class="btn btn-sm btn-icon"><i class="bx bx-show-alt"></Dashboardi></Dashboarda>';
          }
        }
      ],
      order: [[1, 'desc']],
...
(function () {
  /Dashboard/Dashboard On edit role click, update text
  var roleEditList = document.querySelectorAll('.role-edit-modal'),
    roleAdd = document.querySelector('.add-new-role'),
    roleTitle = document.querySelector('.role-title');

  roleAdd.onclick = function () {
    roleTitle.innerHTML = 'Add New Role'; /Dashboard/Dashboard reset text
  };
  if (roleEditList) {
    roleEditList.forEach(function (roleEditEl) {
      roleEditEl.onclick = function () {
        roleTitle.innerHTML = 'Edit Role'; /Dashboard/Dashboard reset text
      };
    });
  }
})();
