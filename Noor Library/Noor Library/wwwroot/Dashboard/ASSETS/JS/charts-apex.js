...
(function () {
  ...
  /Dashboard/Dashboard Color constant
  const chartColors = {
    column: {
      series1: '#826af9',
      series2: '#d2b0ff',
  ...
  /Dashboard/Dashboard Heat chart data generator
  ...
  /Dashboard/Dashboard Line Area Chart
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  const barChartEl = document.querySelector('#barChart'),
    barChartConfig = {
      ...
      xaxis: {
        categories: ['7/Dashboard12', '8/Dashboard12', '9/Dashboard12', '10/Dashboard12', '11/Dashboard12', '12/Dashboard12', '13/Dashboard12', '14/Dashboard12', '15/Dashboard12', '16/Dashboard12'],
        axisBorder: {
          show: false
        },
        axisTicks: {
    ...
    lineChartConfig = {
      ...
      tooltip: {
        custom: function ({ series, seriesIndex, dataPointIndex, w }) {
          return '<div class="px-3 py-2">' + '<span>' + series[seriesIndex][dataPointIndex] + '%</Dashboardspan>' + '</Dashboarddiv>';
        }
      },
      xaxis: {
        categories: [
  ...
  /Dashboard/Dashboard Candlestick Chart
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  /Dashboard/Dashboard Heat map chart
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  /Dashboard/Dashboard Radial Bar Chart
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  /Dashboard/Dashboard Donut Chart
  /Dashboard/Dashboard --------------------------------------------------------------------
