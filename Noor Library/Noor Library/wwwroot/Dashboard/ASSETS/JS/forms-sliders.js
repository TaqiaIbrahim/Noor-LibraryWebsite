...
(function () {
  ...
  /Dashboard/Dashboard Fixed Drag
  /Dashboard/Dashboard --------------------------------------------------------------------
  if (sliderFixedDrag) {
  ...
  /Dashboard/Dashboard Combined Options
  /Dashboard/Dashboard --------------------------------------------------------------------
  if (sliderCombined) {
  ...
  /Dashboard/Dashboard Scale and Pips
  /Dashboard/Dashboard --------------------------------------------------------------------
  if (sliderPips) {
  ...
  /Dashboard/Dashboard Dynamic Slider
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  /Dashboard/Dashboard Connect Upper
  if (connectVertical) {
  ...
  /Dashboard/Dashboard Vertical Tooltip
  if (tooltipVertical) {
