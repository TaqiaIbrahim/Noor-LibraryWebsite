...
(function () {
  ...
  /Dashboard/Dashboard Bootstrap validation example
  /Dashboard/Dashboard------------------------------------------------------------------------------------------
  /Dashboard/Dashboard const flatPickrEL = $('.flatpickr-validation');
  const flatPickrList = [].slice.call(document.querySelectorAll('.flatpickr-validation'));
  /Dashboard/Dashboard Flat pickr
  if (flatPickrList) {
  ...
  /Dashboard/Dashboard Fetch all the forms we want to apply custom Bootstrap validation styles to
  const bsValidationForms = document.querySelectorAll('.needs-validation');

  /Dashboard/Dashboard Loop over them and prevent submission
    ...
    form.addEventListener(
      ...
      function (event) {
        if (!form.checkValidity()) {
          ...
          /Dashboard/Dashboard Submit your form
          alert('Submitted!!!');
        }
...
/Dashboard**
 * Form Validation (https:/Dashboard/Dashboardformvalidation.io/Dashboardguide/Dashboardexamples)
 * ? Primary form validation plugin for this template
 * ? In this example we've try to covered as many form inputs as we can.
 * ? Though If we've miss any 3rd party libraries, then refer: https:/Dashboard/Dashboardformvalidation.io/Dashboardguide/Dashboardexamples/Dashboardintegrating-with-3rd-party-libraries
 */Dashboard
/Dashboard/Dashboard------------------------------------------------------------------------------------------
document.addEventListener('DOMContentLoaded', function (e) {
  (function () {
      ...
      fields: {
        ...
        formValidationDob: {
          validators: {
            ...
            date: {
              format: 'YYYY/DashboardMM/DashboardDD',
      ...
      init: instance => {
        instance.on('plugins.message.placed', function (e) {
          ...
          if (e.element.parentElement.classList.contains('input-group')) {
            /Dashboard/Dashboard `e.field`: The field name
            /Dashboard/Dashboard `e.messageElement`: The message element
            /Dashboard/Dashboard `e.element`: The field element
            e.element.parentElement.insertAdjacentElement('afterend', e.messageElement);
          }
          /Dashboard/Dashboard* Move the error message out of the `row` element for custom-options
    ...
    /Dashboard/Dashboard? Revalidation third-party libs inputs on change trigger

    /Dashboard/Dashboard Flatpickr
    flatpickr(formValidationExamples.querySelector('[name="formValidationDob"]'), {
      ...
      dateFormat: 'Y/Dashboardm/Dashboardd',
    ...
    if (formValidationSelect2Ele.length) {
      formValidationSelect2Ele.wrap('<div class="position-relative"></Dashboarddiv>');
    ...
    /Dashboard/Dashboard Typeahead

    /Dashboard/Dashboard String Matcher function for typeahead
    ...
    /Dashboard/Dashboard Check if rtl
    if (isRtl) {
    ...
    /Dashboard/DashboardBootstrap select
