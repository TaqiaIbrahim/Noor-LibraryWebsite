...
(function () {
  /Dashboard/Dashboard Bootstrap toasts example
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  /Dashboard/Dashboard Animation Button click
  ...
  /Dashboard/Dashboard Dispose toast when open another
  ...
  /Dashboard/Dashboard Placement Button click
...
/Dashboard/DashboardToastr (jquery)
/Dashboard/Dashboard --------------------------------------------------------------------
$(function () {
  var i = -1;
  var toastCount = 0;
  ...
  var getMessage = function () {
    var msgs = [
      ...
      '<div class="mb-3"><input class="input-small form-control mb-1" value="Textbox"/Dashboard>&nbsp;<a href="http:/Dashboard/Dashboardjohnpapa.net" target="_blank">This is a hyperlink</Dashboarda></Dashboarddiv><div class="d-flex"><button type="button" id="okBtn" class="btn btn-danger btn-sm me-2">Close me</Dashboardbutton><button type="button" id="surpriseBtn" class="btn btn-sm btn-success">Surprise me</Dashboardbutton></Dashboarddiv>',
  ...
  var getMessageWithClearButton = function (msg) {
    ...
    msg += '<br /Dashboard><br /Dashboard><button type="button" class="btn btn-sm btn-success clear">Yes</Dashboardbutton>';
    return msg;
  };
  ...
  $('#showtoast').click(function () {
    ...
    /Dashboard/DashboardAdd fix for multiple toast open while changing the position
    ...
    var $toast = toastr[shortCutFunction](msg, title); /Dashboard/Dashboard Wire up an event handler to a button in the toast, if it exists
    $toastlast = $toast;
