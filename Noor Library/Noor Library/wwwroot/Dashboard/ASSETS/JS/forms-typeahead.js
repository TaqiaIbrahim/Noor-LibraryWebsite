...
$(function () {
  /Dashboard/Dashboard String Matcher function
  ...
  /Dashboard/Dashboard Bloodhound Example
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  var prefetchExample = new Bloodhound({
    datumTokenizer: Bloodhound.tokenizers.whitespace,
    queryTokenizer: Bloodhound.tokenizers.whitespace,
    prefetch: assetsPath + 'json/Dashboardtypeahead.json'
  });

  /Dashboard/Dashboard Prefetch Example
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  /Dashboard/Dashboard Render default Suggestions
  ...
  /Dashboard/Dashboard Default Suggestions
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  var customTemplate = new Bloodhound({
    ...
    queryTokenizer: Bloodhound.tokenizers.whitespace,
    prefetch: assetsPath + 'json/Dashboardtypeahead-data-2.json'
  });

  /Dashboard/Dashboard Custom Template
  /Dashboard/Dashboard --------------------------------------------------------------------
  $('.typeahead-custom-template').typeahead(null, {
    ...
    templates: {
      ...
      suggestion: function (data) {
        return '<div><strong>' + data.value + '</Dashboardstrong> – ' + data.year + '</Dashboarddiv>';
      }
    }
  });
  ...
  $('.typeahead-multi-datasets').typeahead(
    ...
    },
    {
      ...
      display: 'team',
      templates: {
        header: '<h4 class="league-name border-bottom mb-0 mx-3 mt-3 pb-2">NBA Teams</Dashboardh4>'
      }
    },
    {
      name: 'nhl-teams',
      ...
      display: 'team',
      templates: {
        header: '<h4 class="league-name border-bottom mb-0 mx-3 mt-3 pb-2">NHL Teams</Dashboardh4>'
      }
    }
  );
});
