...
(function () {
  /Dashboard/Dashboard Flat Picker
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  /Dashboard/Dashboard Multi Date Select
  if (flatpickrMulti) {
  ...
  /Dashboard/Dashboard Human Friendly
  ...
  /Dashboard/Dashboard Disabled Date Range
...
/Dashboard/Dashboard * Pickers with jQuery dependency (jquery)
$(function () {
  /Dashboard/Dashboard Bootstrap Datepicker
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  if (bsDatepickerFormat.length) {
    bsDatepickerFormat.datepicker({
      todayHighlight: true,
      format: 'dd/Dashboardmm/Dashboardyyyy',
      orientation: isRtl ? 'auto right' : 'auto left'
    });
  }
  ...
  /Dashboard/Dashboard Disabled Days
  ...
  /Dashboard/Dashboard Inline picker
  ...
  /Dashboard/Dashboard Bootstrap Daterange Picker
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  /Dashboard/Dashboard Time & Date
  if (bsRangePickerTime.length) {
    bsRangePickerTime.daterangepicker({
      timePicker: true,
      timePickerIncrement: 30,
      locale: {
        format: 'MM/DashboardDD/DashboardYYYY h:mm A'
      },
      opens: isRtl ? 'left' : 'right'
    });
  }
  ...
  /Dashboard/Dashboard Week Numbers
  ...
  /Dashboard/Dashboard jQuery Timepicker
  /Dashboard/Dashboard --------------------------------------------------------------------
  ...
  /Dashboard/Dashboard Disabled Picker
  ...
  /Dashboard/Dashboard Format Picker
  ...
  /Dashboard/Dashboard Steps Picker
  ...
  /Dashboard/Dashboard 24 Hours Format
...
/Dashboard/Dashboard color picker (pickr)
/Dashboard/Dashboard --------------------------------------------------------------------
(function () {
  ...
  if (classicPicker) {
    pickr.create({
      ...
      components: {
        ...
        /Dashboard/Dashboard Input /Dashboard output Options
        interaction: {
          hex: true,
          rgba: true,
          hsla: true,
